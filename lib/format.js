...
export const TIERS = {
  a: { label: 'A', color: '#4B3BE0', bg: '#EEECFD' },
  b: { label: 'B', color: '#12805C', bg: '#E7F5F0' },
  c: { label: 'C', color: '#86848F', bg: '#F1F0F5' },
};
...
export function temp(days) {
  if (days === null) return { pct: 0, color: '#8C8A96', bg: '#F1F0F5', label: 'new' };
  if (days <= 7) return { pct: 1, color: '#12805C', bg: '#E7F5F0', label: `${days}d` };
  if (days <= 21) return { pct: 0.6, color: '#A87400', bg: '#FBF3DE', label: `${days}d` };
  if (days <= 60) return { pct: 0.3, color: '#D6336C', bg: '#FCEBF1', label: `${days}d` };
  return { pct: 0.08, color: '#D6336C', bg: '#FCEBF1', label: `${days}d` };
}
