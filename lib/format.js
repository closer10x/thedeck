...
const NOT_HANDLES = new Set([
  ...
  'tv',
  's',
  'share', // what the app's share sheet hands you: /share/_pAbC123
  'explore',
  'accounts',
  'direct',
  'about',
...
export function parseHandle(input) {
  ...
  // instagram.com/_u/janedoe is the app's own deep link — the handle is the
  // segment after it, not the _u
  const url = s.match(/instagram\.com\/(?:_u\/)?([A-Za-z0-9._]+)/i);
  if (url) {
